...
trống đỉnh trang và tự động tính toán số liệu xuất tuyến.
"""
...
# 2. TÙY CHỈNH GIAO DIỆN CSS MODERN EVN COMPACT (THU NHỎ KHUNG & ĐỈNH TRANG)
st.markdown(
    """
<style>
